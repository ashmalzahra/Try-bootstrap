...
A prototype of the portfolio website from scratch using the power of a CSS framework - Bootstrap.
...
Feel free to check the [issues page](https://github.com/ashmalzahra/Try-bootstrap/issues).
